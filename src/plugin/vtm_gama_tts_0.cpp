...
{
	try {
		return new GS::VTM::VocalTractModel0<double>(*reinterpret_cast<GS::ConfigurationData*>(config_data), is_interactive);
...
{
	delete reinterpret_cast<GS::VTM::VocalTractModel0<double>*>(vtm);
}
