...
{
	try {
		return new GS::VTM::VocalTractModel2<double, 1>(*reinterpret_cast<GS::ConfigurationData*>(config_data), is_interactive);
...
{
	delete reinterpret_cast<GS::VTM::VocalTractModel2<double, 1>*>(vtm);
}
