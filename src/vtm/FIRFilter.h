...
#ifndef VTM_FIR_FILTER_H_
#define VTM_FIR_FILTER_H_
...
class FIRFilter {
public:
	FIRFilter(FloatType beta, FloatType gamma, FloatType cutoff);
	~FIRFilter() {}
...
template<typename FloatType>
FIRFilter<FloatType>::FIRFilter(FloatType beta, FloatType gamma, FloatType cutoff)
{
...
template<typename FloatType>
int
FIRFilter<FloatType>::maximallyFlat(FloatType beta, FloatType gamma, int* np, FloatType* coefficient)
{
...
template<typename FloatType>
void
FIRFilter<FloatType>::trim(FloatType cutoff, int* numberCoefficients, FloatType* coefficient)
{
...
template<typename FloatType>
int
FIRFilter<FloatType>::increment(int pointer, int modulus)
{
	if (++pointer >= modulus) {
		return 0;
	} else {
...
template<typename FloatType>
int
FIRFilter<FloatType>::decrement(int pointer, int modulus)
{
	if (--pointer < 0) {
		return modulus - 1;
	} else {
...
template<typename FloatType>
void
FIRFilter<FloatType>::rationalApproximation(FloatType number, int* order, int* numerator, int* denominator)
{
